...
enum PixelFormat
{
	...
	PF_ETC1=42,
	PF_R8 = 43,					// -- begin liuzx
	PF_RG8 = 44,
	PF_PVRTC2_2BPP = 45,
	PF_PVRTC2_4BPP = 46,		// -- end liuzx
...
public:
	...
	*/
	static size_t getMemorySize(size_t width, size_t height, size_t depth, PixelFormat format,
			unsigned int iMipLevel=0,unsigned int u32NumSurfaces=1,
						bool bAllSurfaces=true);	//TODO xialh
	

	static unsigned int getETCSize(unsigned int width,unsigned int height,unsigned int depth,
			unsigned int iMipLevel=0,unsigned int u32NumSurfaces=1,
			bool bAllSurfaces=true);	//TODO xialh
