...
public:
	...
	*/
    ...
    _un_export friend Vector3 operator* (const Vector3& rkVector,
    ...
    // scalar * matrix
    _un_export friend Matrix3 operator* (Real fScalar, const Matrix3& rkMatrix);
	...
	*/
// 		inline _un_export friend std::ostream& operator <<
