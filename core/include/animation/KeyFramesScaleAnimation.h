#ifndef __KeyFramesScaleAnimation_h__
#define __KeyFramesScaleAnimation_h__
 ...
 *
 */
class KeyFramesScaleAnimation : public Animation
{
private:
	Transform* mTarget;
...
public:
    ...
    KeyFramesScaleAnimation(Root* root, Transform* target, bool canStop = true) : Animation(root, canStop) {
    	_init();
    	mTarget = target;
    }
