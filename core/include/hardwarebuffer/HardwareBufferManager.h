...
//#include "HardwareCounterBuffer.h"
#include "HardwareUniformBuffer.h"
...
protected:
	/** WARNING: The following two members should place before all other members.
		...
		two members.
	*/
	typedef set<HardwareVertexBuffer*> VertexBufferList;
	typedef set<HardwareIndexBuffer*> IndexBufferList;
	typedef set<HardwareUniformBuffer*> UniformBufferList;
//	typedef set<HardwareCounterBuffer*> CounterBufferList;
...
//	CounterBufferList mCounterBuffers;
	...
	typedef set<VertexDeclaration*> VertexDeclarationList;
	typedef set<VertexBufferBinding*> VertexBufferBindingList;
...
protected:
	...
	typedef multimap<HardwareVertexBuffer*, HardwareVertexBufferSharedPtr> FreeTemporaryVertexBufferMap;
	...
	typedef map<HardwareVertexBuffer*, VertexBufferLicense> TemporaryVertexBufferLicenseMap;
...
public:
	HardwareBufferManagerBase(Root* root);
