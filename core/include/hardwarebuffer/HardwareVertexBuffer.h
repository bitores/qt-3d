...
public:
	...
	*/
	...
	static VertexElementType getBestColourVertexElementType(Root* root);
...
protected:
	...
	HardwareBufferManagerBase* mHardwareBufferManagerBase;
public:
	/// Standard constructor, not you should use HardwareBufferManager::createVertexDeclaration
	VertexDeclaration(HardwareBufferManagerBase* pHardwareBufferManagerBase);
	...
	*/
	virtual const VertexElement& addElement(Root* root, unsigned short source, size_t offset, VertexElementType theType,
		VertexElementSemantic semantic, unsigned short index = 0);
	...
	@return A reference to the VertexElement added.
	*/
	virtual const VertexElement& insertElement(Root* root, unsigned short atPosition,
...
public:
	...
	*/
	...
	typedef map<ushort, ushort> BindingIndexMap;
