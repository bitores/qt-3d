...
protected:
	...
	virtual DataStreamPtr openImpl(const String& filename, bool readOnly = true) const = 0;
public:
	// TODO liuzx
	String mPrefix;
...
//	virtual DataStreamPtr open(const String& filename, bool readOnly = true) const = 0;
	DataStreamPtr open(Root* root, const String& filename, bool readOnly = true) const;
