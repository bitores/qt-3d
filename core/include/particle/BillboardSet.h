...
#include "base/eCommon.h"
    ...
    */
    class  BillboardSet : public IMesh
    {
    protected:
    	Root* mRoot;
        /** Private constructor (instances cannot be created directly).
        */
        BillboardSet(Root* root);
...
//        MaterialPtr mpMaterial;
        ...
        typedef list<Billboard*> ActiveBillboardList;
        typedef list<Billboard*> FreeBillboardList;
        ...
        */
        ...
        Vector3Radius genVertices(const Vector3* const offsets, const Billboard& pBillboard, bool touch = false);
...
//		static RadixSort<ActiveBillboardList, Billboard*, float> mRadixSorter;
    ...
    public:
        ...
        */
        BillboardSet(Root* root, /*const String& name, */unsigned int poolSize = 20,
...
//        virtual const String& getMaterialName(void) const;
        ...
        */
        ...
        /** Define a billboard. */
        Vector3Radius injectBillboard(const Billboard& bb, bool touch = false);
...
//			bool debugRenderables = false);
        ...
        */
        ...
        virtual FloatRect & getTextureCoords( uint16 index );
