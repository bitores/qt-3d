...
#include "base/ScriptLoader.h"
    ...
    */
    class ParticleSystemManager: /*public Singleton<ParticleSystemManager>,*/ public ScriptLoader/*, public IAsset*/
    {
		friend class ParticleSystemFactory;
	public:
        typedef map<String, ParticleSystem*> ParticleTemplateMap;
		typedef map<String, ParticleAffectorFactory*> ParticleAffectorFactoryMap;
		typedef map<String, ParticleEmitterFactory*> ParticleEmitterFactoryMap;
		typedef map<String, ParticleSystemRendererFactory*> ParticleSystemRendererFactoryMap;
    protected:
		OGRE_AUTO_MUTEX
			
		Root* mRoot;

		ParticleTemplateMap mActiveParticleSystem;
    ...
    public:
        ...
        ParticleSystemManager(Root* root);
        virtual ~ParticleSystemManager();

        void _initialise(void);
        void _destroy();

        void _installRendererFactorys();
        void _destroyRendererFactorys();

        void _installEmitterAffectorFactorys();
        void _destroyEmitterAffectorFactorys();

//        void _destroyParticleTemplates();
        void _destroyActiveParticleSystem();

//		void destroyParticleSystem(ParticleSystemList & particleSystemList);

//		void copyToParticleList(ParticleSystemList & particleSystemList);

//		void addParticleSystemToRoot();
        ...
        */
		...
		ParticleTemplateMap& getTemplateMap();

		ParticleTemplateMap& getActiveParticleSystemMap();
