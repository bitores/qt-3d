...
#include "BillboardSet.h"
    ...
    protected:
        ...
        vector<MotionEvent> mMotionEventList;
    public:
        BillboardParticleRenderer(Root* root);
...
//		};
        ...
        */
        ...
        void _updateRenderQueue(list<Particle*>& currentParticles, bool cullIndividually);
...
//        void _setMaterial(MaterialPtr& mat);
        ...
        void _notifyStacksAndSlices(uchar stacks, uchar slices);
...
//		static CmdAccurateFacing msAccurateFacingCmd;
    ...
    {
    public:
    	BillboardParticleRendererFactory(Root* root);
