...
public:
	...
	*/
	typedef list<IndexRemap> IndexRemapList;

	typedef list<VertexSplit> VertexSplits;
...
protected:
	...
	VertexData* mVData;
	typedef vector<IndexData*> IndexDataList;
	typedef vector<RenderOperation::OperationType> OpTypeList;
