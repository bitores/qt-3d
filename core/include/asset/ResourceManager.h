...
public:
	...
	*/
	virtual void unload(const String& name, const String& groupName);
	...
	*/
	...
	@note
		...
		shared pointers before you shutdown OGRE.
	*/
	virtual void remove(const String& name, const String& groupName);
	...
	*/
	...
	virtual bool resourceExists(const String& name, const String& groupName)
	{
		return !getResourceByName(name, groupName).isNull();
	}
