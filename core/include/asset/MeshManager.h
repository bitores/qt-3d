...
#include "hardwarebuffer/HardwareBuffer.h"
#include "ui/eRect.h"
...
//	void _initialise(void);
	...
	*/
	...
	void loadMeshes(const String& filename, const String& groupName);
	void loadMeshesV2(const String& filename, const String& groupName);
	void loadMeshsPod(const String& fileName,const String&groupName);
...
//	void createPrefabSphere(void);
	...
	typedef map<Resource*, MeshBuildParams> MeshBuildParamsMap;
...
class UIMeshManager : public MeshManager
{
public:
public:
	UIMeshManager(Root* root);
	~UIMeshManager();
...
//	void _initialise(void);
	...
	/// Get a resource by name
	/// @see ResourceManager::getResourceByName
	eRectPtr getByName(const String& name, const String& groupName/* = ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME*/);


	/// Create a new mesh
	/// @see ResourceManager::createResource
	eRectPtr create (const String& name, const String& group,
						bool isManual = false, ManualResourceLoader* loader = 0,
						const NameValuePairList* createParams = 0);
protected:
	/// @copydoc ResourceManager::createImpl
