...
#include "Resource.h"
#include "hardwarebuffer/VertexIndexData.h"
...
class Mesh : public Resource, public IMesh
{
...
public:
//	typedef vector<Real> LodValueList;
//	typedef vector<MeshLodUsage> MeshLodUsageList;
//	/// Multimap of vertex bone assignments (orders by vertex index)
//	typedef multimap<size_t, VertexBoneAssignment> VertexBoneAssignmentList;
//	typedef MapIterator<VertexBoneAssignmentList> BoneAssignmentIterator;
//	typedef vector<unsigned short> IndexMap;
...
//	typedef map<String, Animation*> AnimationList;
...
//		const map<size_t, Vector3>& vertexOffsetMap,
//		VertexData* targetVertexData);
