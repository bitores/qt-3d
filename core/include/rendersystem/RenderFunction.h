#ifndef __RenderFunction_H_
#define __RenderFunction_H_
...
*  @{
*/
/** \addtogroup RenderFunction
*  @{
*/

typedef vector<DepthBuffer*> DepthBufferVec;
typedef map< uint16, DepthBufferVec > DepthBufferMap;
typedef map< String, RenderTarget * > RenderTargetMap;
typedef multimap<uchar, RenderTarget * > RenderTargetPriorityMap;
...
@remarks
The RenderFunction class provides a base interface
...
1.0
*/
class RenderFunction/* : public RenderSysAlloc*/
{
public:
	/** Default Constructor.
	*/
	RenderFunction(Root* root);
...
//	virtual ConfigOptionMap& getConfigOptions(void) = 0;
	...
	RenderFunction::initialise or RenderFunction::reinitialise
	are called.
	@par
	If using a custom configuration dialog, it is advised that the
	caller calls RenderFunction::getConfigOptions
...
//	virtual String validateConfigOptions(void) = 0;
	...
	*/
	...
	/** Query the real capabilities of the GPU and driver in the RenderFunction*/
	virtual RenderSystemCapabilities* createRenderSystemCapabilities() const = 0;

	/** Get a pointer to the current capabilities being used by the RenderFunction.
	@remarks
	The capabilities may be modified using this pointer, this will only have an effect
	before the RenderFunction has been initialised. It's intended use is to allow a
	listener of the RenderSystemCapabilitiesCreated event to customise the capabilities
	on the fly before the RenderFunction is initialised.
	*/
	...
	*/
	...
	<tr>
		<td>FSAAHint</td>
		<td>Depends on RenderFunction and hardware. Currently supports:<br/>
...
//		RenderWindowList& createdWindows);
	...
	*/
	...
	/** Returns a specialised MapIterator over all render targets attached to the RenderFunction. */
	...
	*/
	...
	/** The RenderFunction will keep a count of tris rendered, this resets the count. */
	...
	use as with this RenderFunction.
	@remarks
...
//	virtual const String& _getDefaultViewportMaterialScheme(void) const;
	...
	*/
	...
	@see RenderFunction::setInvertVertexWinding
	*/
	...
	*/
	...
	can raise.
	@see RenderFunction::addListener
	*/
	class Listener
	{
	public:
	...
	@see RenderFunction::getRenderSystemEvents
	*/
	...
	*/
	...
	@see RenderFunction::preExtraThreadsStarted
	*/
	...
	*/
	...
	@see RenderFunction::registerThread
	*/
	...
	*/
	...
	virtual HardwareBufferManager* getHardwareBufferManager() = 0;
...
protected:
	...
	ColourValue mManualBlendColours[E3D_MAX_TEXTURE_LAYERS][2];
	...
	*/
	...
	typedef list<HardwareOcclusionQuery*> HardwareOcclusionQueryList;
