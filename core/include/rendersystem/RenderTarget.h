...
/** A 'canvas' which can receive the results of a rendering
	...
	@version
		1.0
 */
class RenderTarget : public Object/* : public RenderSysAlloc*/
{
public:
	enum StatFlags
	{
	...
	RenderTarget(Root* root, unsigned int width = 1, unsigned int height = 1);
	...
	*/
	...
	void _updateAutoUpdatedViewports(Real width, Real height);
