...
#include "utils/include/Matrix4.h"
#include "utils/include/Vector4.h"
...
protected:
	...
	mutable Matrix4 mTextureViewProjMatrix[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable Matrix4 mTextureWorldViewProjMatrix[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable Matrix4 mSpotlightViewProjMatrix[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable Matrix4 mSpotlightWorldViewProjMatrix[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable Vector4 mShadowCamDepthRanges[E3D_MAX_SIMULTANEOUS_LIGHTS];
	...
	mutable bool mTextureViewProjMatrixDirty[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable bool mTextureWorldViewProjMatrixDirty[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable bool mSpotlightViewProjMatrixDirty[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable bool mSpotlightWorldViewProjMatrixDirty[E3D_MAX_SIMULTANEOUS_LIGHTS];
	mutable bool mShadowCamDepthRangesDirty[E3D_MAX_SIMULTANEOUS_LIGHTS];
...
//	const Renderable* mCurrentRenderable;
	const GameObject* mCurrentRenderable;
	const Camera* mCurrentCamera;
	bool mCameraRelativeRendering;
	Vector3 mCameraRelativePosition;
	const LightList* mCurrentLightList;
	const Frustum* mCurrentTextureProjector[E3D_MAX_SIMULTANEOUS_LIGHTS];
...
public:
	...
	virtual void setCurrentRenderable(const GameObject* rend);
...
//	virtual void setMainCamBoundsInfo(VisibleObjectsBoundsInfo* info);
	...
	virtual ColourValue getDerivedAmbientLightColour() const;
	...
	virtual const GameObject* getCurrentRenderable(void) const;
