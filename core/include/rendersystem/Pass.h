...
#include "rendersystem/TextureUnitState.h"
...
*/
class Pass : public Object/*, public StringInterface*/
{
public:
	...
	*/
	...
	//class CmdVertexProgramRef: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdFragmentProgramRef: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdAmbient: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdDiffuse: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdSpecular: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdEmissive: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdShininess: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdDepthCheck: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	...
	//	void doSet(void* target, const String& val);
	//};
	//class CmdCullingMode: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdDepthBiasMode: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
	//class CmdIterationDepthBiasMode: public ParamCommand {
	//public:
	//	String doGet(const void* target) const;
	//	void doSet(void* target, const String& val);
	//};
protected:
    //static CmdVertexProgramRef msVerertexProgramRefCmd;
    //static CmdFragmentProgramRef msFragmentProgramRefCmd;
    //
    //static CmdAmbient msAmbientCmd;
    //static CmdDiffuse msDiffuseCmd;
    //static CmdSpecular msSpecularCmd;
    //static CmdEmissive msEmissiveCmd;
    //static CmdShininess msShininessCmd;
    //static CmdDepthCheck msDepthCheckCmd;
    //static CmdDepthWrite msDepthWriteCmd;
    //static CmdCullingMode msCullingModeCmd;
    //static CmdDepthBiasMode msDepthBiasCmd;
    //static CmdIterationDepthBiasMode msIterationDepthBiasCmd;
...
protected:
	...
	typedef vector<TextureUnitState*> TextureUnitStates;
	...
	typedef vector<unsigned short> ContentTypeLookup;
...
public:
	...
	/// Default constructor
	Pass(Material* parent, unsigned short index);
	/// Copy constructor
	Pass(Material* parent, unsigned short index, const Pass& oth );
	/// Operator = overload
	...
	GpuProgramUsage *getVertexProgramUsage() { return mVertexProgramUsage; }

	GpuProgramUsage *getFragmentProgramUsage() { return mFragmentProgramUsage; }
...
//	ConstTextureUnitStateIterator getTextureUnitStateIterator(void) const;
	...
	*/
	...
	@param resetParams
		...
		not just the names.
	*/
	void setVertexProgram(const String& name/*, const String& groupName*/, bool resetParams = true);
	...
	*/
	...
	@param resetParams
		...
		not just the names.
	*/
	void setFragmentProgram(const String& name/*, const String& groupName*/, bool resetParams = true);
...
typedef vector<IlluminationPass*> IlluminationPassList;
