...
//	typedef map<String, unsigned short> SchemeMap;
...
//	virtual void setActiveScheme(const String& schemeName);
	...
	*/
	virtual void addListener(Listener* l, const String& schemeName = StringUtil::BLANK);
	...
	*/
	virtual void removeListener(Listener* l, const String& schemeName = StringUtil::BLANK);
