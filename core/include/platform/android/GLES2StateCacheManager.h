 ...
 */
class GLES2StateCacheManager/* : public StateCacheAlloc*/
{
private:
	GLES2StateCacheManagerImp* mImp;
	RenderFunction*	 mRenderFunction;
public:
	GLES2StateCacheManager(RenderFunction* renderFunction);
	...
	*/
	 ...
	 */
	vector<GLboolean> & getColourMask(void) const;
	...
	RenderFunction* getRenderFunction() const {return mRenderFunction;}
};
