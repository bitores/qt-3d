...
//           void _notifyMoved(void);
           ...
           // override Component::_notifyAttached(GameObjec* parent)
           void _notifyAttached(GameObject* parent);

           // override Component::_notifyTransformChanged
...
//           */
           ...
           */
           bool isInLightRange(const Sphere& sphere) const;
           ...
           @note
               ...
               false-positives (The function should not return any false-negatives).
           */
           bool isInLightRange(const AxisAlignedBox& container) const;
    protected:
...
//
	   typedef map<uint16, Vector4> CustomParameterMap;
