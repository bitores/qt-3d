...
#if defined(_DEBUG_) || defined(_DEBUG_TEXTURE_ANIMATION_)
...
public:
	...
	*/
	void update(void)
	{
//#ifdef _DEBUG_TEXTURE_ANIMATION_
//		LogManager::log(TAG_TEX_ANI, "Controller::update 1111111111");
//#endif
		if(mEnabled) {
//#ifdef _DEBUG_TEXTURE_ANIMATION_
//			LogManager::log(TAG_TEX_ANI, "Controller::update 1111111111111 src %x dst %x func %x", mSource.getPointer(), mDest.getPointer(), mFunc.getPointer());
//#endif
//			T src = mSource->getValue();
//#ifdef _DEBUG_TEXTURE_ANIMATION_
//			LogManager::log(TAG_TEX_ANI, "Controller::update 2222222222222 src %f", src);
//#endif
//			T dst = mFunc->calculate(src);
//#ifdef _DEBUG_TEXTURE_ANIMATION_
//			LogManager::log(TAG_TEX_ANI, "Controller::update 3333333333333 dst %f", dst);
//#endif
//			mDest->setValue(dst);
//#ifdef _DEBUG_TEXTURE_ANIMATION_
//			LogManager::log(TAG_TEX_ANI, "Controller::update 4444444444444");
//#endif
