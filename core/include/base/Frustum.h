...
#include "utils/include/MovablePlane.h"
...
*/
class Frustum : public Component /*: public MovableObject, public Renderable*/
{
protected:
	Root *mRoot;
...
public:
	...
	/// Named constructor
	Frustum(Root* root, const String& name = StringUtil::BLANK);
